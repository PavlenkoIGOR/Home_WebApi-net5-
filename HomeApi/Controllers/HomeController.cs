...
namespace HomeApi.Controllers
{
    ...
    public class HomeController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet] //в swaggere будут раздел [get]: /Home/info
        [Route("info")]  //в {}-скобках это то, что эквивалентно placeholder в HTML. Если отличаются
                         //имена в [Route("{моёИмя}")] и в IActionResult Get([FromRoute] string моёИмя) то будет два поля для ввода
